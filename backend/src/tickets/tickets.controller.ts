...
export class TicketsController {
  ...
  /**
   * Cambio de estado en lote desde la tabla de tickets. Declarado antes que `:id` para
   * que Nest no lo tome por un id.
   */
  @Patch('status')
  ...
  updateStatusMany(
    ...
    return this.ticketsService.updateStatusMany(dto.ids, dto.status, user);
  }
